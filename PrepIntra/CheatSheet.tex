...
\begin{multicols*}{3}
  ...
  .2 Questions clés pour un bon design.
    ...
    \begin{itemize}
      ...
      \end{itemize}
      \item \textbf{Expliquer toutes les exigences d'entrées}  
        \begin{itemize}
          \item [$\blacktriangleright$ ] P. ex. \texttt{mdp} 
            doit contenir des caractères spéciaux
    \begin{figure}[H]
      \begin{center}
        \includegraphics[width=0.35\textwidth]{Formulaire1.png}
      \end{center}
    \end{figure}
        \end{itemize}
    \end{itemize}
      \item \textbf{Supprimer les champs optionnel
        tant que possible}   
    \begin{itemize}
      \item Ne pas faire un sondage lors de 
        \texttt{sign-up}  
    \begin{figure}[H]
      \begin{center}
        \includegraphics[width=0.35\textwidth]{Fo2.png}
      \end{center}
    \end{figure}
    \end{itemize}


      \item \textbf{Indiquer clairement quel champssont optionnel}   
    \begin{itemize}
      \item  P. ex. avec astérix
    \begin{figure}[H]
      \begin{center}
        \includegraphics[width=0.35\textwidth]{Fo3.png}
      \end{center}
    \end{figure}
    \end{itemize}
